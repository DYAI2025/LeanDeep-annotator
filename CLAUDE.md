...
- **Implementation progress**: 7/14 tasks done (P0: 3/3, P1: 4/6). Marker sidebar with search/filter/detail view built; vitest test infrastructure added. 4 decisions recorded
